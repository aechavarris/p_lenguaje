...
% detecta correctamente las excepciones de acciones incorrectas, ya sea 
% por invocarlas con parametros de mas, de menos o con el tipo erroneo.
% [Lineas 109, 110 y 111]
%-----------------------------------------------------------
...
%-----------------------------------------------------------
ACCION primer_dia_mes(ref entero a);
...
PRINCIPIO
     ...
     leer(anho, ln);
     primer_dia_anho;
	 % Accion incorrecta, parametros insuficientes, parametros de mas
	 % parametros incorrectos
     primer_dia_mes(2);
	 primer_dia_mes;
	 primer_dia_mes(2,anho);
	 % Accion incorrecta, parametros insuficientes, parametros de mas
	 % parametros incorrectos
     escribir(dia1mes);    

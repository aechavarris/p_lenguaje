...
% detecta correctamente las excepciones de valores fuera de rango en
% entacar, acciones y programas usados en expresiones y expresiones
% no validas (tipos incorrectos).
% [Lineas 50, 51 y 52]
%-----------------------------------------------------------
...
%-----------------------------------------------------------
       ...
       booleano bisiestos_validos,cien,cuatro;
	   %Simbolos no asignables, out of bonds y expresiones invalidas
	   ACCION bisiestos_validos;
		   principio	
		   fin
       principio
           cien:=caca+2;
